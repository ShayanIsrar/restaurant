        ...
        <div className="container flex justify-between py-4 sm:py-3">
          ...
          <div>
            <ul className="flex items-center gap-10">
              ...
              <li>
                <button onClick={handlePopUp} className="flex justify-center items-center gap-2 bg-secondary text-[16px] sm:text-[16px] lg:text-xl h-[40px] text-white px-5 py-2 hover:scale-105 duration-300">
                    <FaUser/>
                    My Account
                </button>
              </li>
